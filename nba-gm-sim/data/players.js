...
const NBA_PLAYERS_RAW = [
  ...
  player('Larry Nance Jr.',      'PF', 'ATL', 31, 70, 62, 58, 70, 72, 70, 66,   9.7, 2),
  ...
  player('Andre Drummond',       'C',  'CHI', 31, 70, 62, 48, 66, 74, 62, 60,   3.5, 1),
  ...
  player('Donte DiVincenzo',     'SG', 'NYK', 27, 76, 76, 66, 66, 72, 68, 70, 13.0, 3),
  ...
  player('Reggie Jackson',       'PG', 'PHI', 34, 66, 64, 65, 56, 60, 65, 50,   2.5, 1),
  ...
  player('Eric Gordon',          'SG', 'PHX', 36, 69, 73, 56, 56, 60, 65, 52,   5.0, 1),
  ...
  player('Gary Trent Jr.',       'SG', 'TOR', 25, 74, 78, 58, 62, 70, 66, 68,   7.0, 1),
  ...
  player('Malcolm Brogdon',      'PG', 'WAS', 32, 72, 70, 68, 60, 62, 70, 58,  12.0, 1),
